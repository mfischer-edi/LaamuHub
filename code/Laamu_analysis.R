...
(cor.perc.change.plot <- ggplot(change, aes(x = reorder(Site, desc(perc.change)), 
    ...
    scale_fill_manual(values = c("#1e8df4", "#d42020")) +
...
ggsave(cor.perc.change.plot, filename = "outputs/cor_perc_change.png", width = 10, height = 8)
...
ggsave(plot1, filename = "outputs/perc.2019.png", width = 10, height = 8)
